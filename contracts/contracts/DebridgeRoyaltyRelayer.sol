...
contract DebridgeRoyaltyRelayer {
    address public constant DLN_DESTINATION =
        0xE7351Fd770A37282b91D153Ee690B63579D6dd7f;
    address public constant MULTICALL =
    ...
    modifier onlyDeBridgeGate() {
        require(
            msg.sender == DLN_DESTINATION,
            "DebridgeRoyaltyRelayer: caller is not DLN_DESTINATION"
        );
        _;
    }
