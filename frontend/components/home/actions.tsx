...
export default function Actions({
  ...
  return (
    <div className="2xl:relative absolute 2xl:top-[0%] 2xl:left-[0%] left-[24%] w-[68%] 2xl:h-full h-[600px]  bg-[#1F1F1F] rounded-sm">
      <div className="absolute w-full h-full flex flex-col -top-[0.5%] -left-[0.5%] space-y-2 sen rounded-sm text-sm border-[2px] border-white py-2 bg-[#1F1F1F] text-white">
            ...
            <tbody>
              {actions &&
                actions.map((item, id) => (
                  <tr
                    key={id}
                    className="border-b border-white/20 hover:bg-[#1F1F1F]/5"
                  >
